...
|---------------|----------|-----|-----------|--------|----|-----|
| Logistic Regression | 0.985 | 0.998 | 0.983 | 0.991 | 0.987 | 0.969 |
| Decision Tree | 0.980 | 0.981 | 0.991 | 0.974 | 0.983 | 0.959 |
| kNN | 0.920 | 0.971 | 0.939 | 0.922 | 0.930 | 0.836 |
| Naive Bayes | 0.945 | 0.992 | 0.934 | 0.974 | 0.954 | 0.887 |
| Random Forest (Ensemble) | 0.985 | 0.998 | 0.983 | 0.991 | 0.987 | 0.969 |
| XGBoost (Ensemble) | **0.990** | **0.9997** | **0.991** | **0.991** | **0.991** | **0.979** |
